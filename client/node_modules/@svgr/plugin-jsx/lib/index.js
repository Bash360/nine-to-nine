...
var _hastUtilToBabelAst = _interopRequireDefault(
  require('@svgr/hast-util-to-babel-ast'),
);
...
function jsxPlugin(code, config, state) {
  ...
  const { code: generatedCode } = (0, _core.transformFromAstSync)(
    babelTree,
    code,
    _extends(
      {
        ...
        presets: [
          (0, _core.createConfigItem)(
            [
              _babelPreset.default,
              _extends({}, config, {
                state,
              }),
            ],
