...
var _getOptionSpecificExcludes = _interopRequireDefault(
  require('./get-option-specific-excludes'),
);
...
var _usagePlugin = _interopRequireDefault(
  require('./polyfills/corejs2/usage-plugin'),
);

var _usagePlugin2 = _interopRequireDefault(
  require('./polyfills/corejs3/usage-plugin'),
);

var _usagePlugin3 = _interopRequireDefault(
  require('./polyfills/regenerator/usage-plugin'),
);

var _entryPlugin = _interopRequireDefault(
  require('./polyfills/corejs2/entry-plugin'),
);

var _entryPlugin2 = _interopRequireDefault(
  require('./polyfills/corejs3/entry-plugin'),
);

var _entryPlugin3 = _interopRequireDefault(
  require('./polyfills/regenerator/entry-plugin'),
);
