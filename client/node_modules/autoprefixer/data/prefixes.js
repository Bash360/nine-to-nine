...
f(require('caniuse-lite/data/features/css-filter-function'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/css-element-function'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/background-img-opts'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/background-clip-text'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/css-boxdecorationbreak'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/css-deviceadaptation'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/css-text-align-last'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/css-read-only-write'), function(
  browsers,
) {
...
f(require('caniuse-lite/data/features/css-text-orientation'), function(
  browsers,
) {
